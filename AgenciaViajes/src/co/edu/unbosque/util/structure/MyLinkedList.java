...
public class MyLinkedList<E> {
	...
	/* Si estoy buscando una posición que no existe, debo retornar nulo, en caso de
	 * estar contando, debo retornar un número negativo*/
	...
	// Pueden existir datos repetidos, sin ningún inconveniente.
	...
	/*  El toString de la lista no es el mismo del nodo, y el del nodo
	 * no es el mismo de su contenido
	 * */
